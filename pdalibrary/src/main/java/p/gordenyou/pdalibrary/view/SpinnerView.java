...
public class SpinnerView extends LinearLayout {
    ...
    public SpinnerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        View view = inflater.inflate(R.layout.view_spinner_wide, this);
        title = view.findViewById(R.id.spinner_title);
        spinner = view.findViewById(R.id.spinner_spinner);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SpinnerView);
        title.setText(a.getText(R.styleable.SpinnerView_spinnertitle));

        a.recycle();
    }


    public void setSpinnerList(Context context, Object[] list) {
